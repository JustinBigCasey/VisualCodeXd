...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Mickey Area: " + mickeyHouse.getUsableArea());
        System.out.println("Compenses for Mickey: " + mickeyHouse.calculateCompensationPrice());
        System.out.println("Compenses for Donald: " + donaldHouse.calculateCompensationPrice());

        System.out.println("h1 and h2: " + h1.equals(h2));
